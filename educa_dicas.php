...
<div class="navbar">
  ...
  <a href="blur1.php"><img  src="assets/noticiaprincipa.png" alt="" width=100%;></a>
  <br>
  <br>
<div class='buttons'>
  ...
  <a href="blur1.php">
    <img class="imagemr" src="assets/dica1.png" alt="" style="width: 80%;border-radius: 5%;margin: 10px;margin-left: 15%;margin-top: 3%;position: relative;text-align: center;">
  </a>
  <a href="blur1.php">
    <img class="imagemr" src="assets/dica2.png" alt="" style="width: 80%;border-radius: 5%;margin: 10px;margin-left: 15%;margin-top: 3%;position: relative;text-align: center;">
  </a>
</div>
  <div class="buttons">
