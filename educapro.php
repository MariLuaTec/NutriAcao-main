...
<br>
    ...
    </b><br>Apesar de ser uma grande cidade, Manaus enfrenta desafios de segurança alimentar em suas áreas rurais devido à falta de infraestrutura, acesso limitado a alimentos frescos e pobreza generalizada. Isso resulta em comunidades vulneráveis lutando para obter alimentos nutritivos em quantidade suficiente.</p>
  </div>
  <div class="holder" style=" display: flex;justify-content: center;">
    ...
    Para combater o desperdício de alimentos e abordar a insegurança alimentar, várias iniciativas locais foram implementadas em Manaus, incluindo programas de redistribuição de alimentos excedentes para comunidades carentes, incentivo ao reaproveitamento de alimentos e educação sobre práticas alimentares sustentáveis.
    </p></div>
<div class="holder" style=" display: flex;justify-content: center;">
    <img class="imagemr" src="assets/ongeduca.jpeg" alt="" style="width: 30%;border-radius: 5%;margin: 5px;margin-left: 5%;margin-top: 3%;position: relative;text-align: center;">
    <p style="margin-top:5%; margin-left:2%;"><b>Projetos de educação alimentar e nutricional: </b><br>Algumas ONGs focaram em projetos de educação alimentar e nutricional no Amazonas, oferecendo workshops, palestras e materiais educativos para ensinar práticas de alimentação saudável, aproveitamento integral dos alimentos e técnicas de cultivo sustentável. Essas iniciativas visam capacitar as comunidades locais para fazerem escolhas alimentares mais saudáveis e sustentáveis, contribuindo para a segurança alimentar a longo prazo.</p>
</div>
